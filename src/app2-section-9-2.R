...
colnames(x.hansen) = c('_const',paste('_R1_t',rep(1:12),sep='_'), '_R2const',paste('_R2_t',rep(1:12),sep='_'))
...
output_text_file_name <- "../results/app2-section9-2.txt"
...
colnames(x.est) = c('_const',paste('_R1_t',rep(1:12),sep='_'), '_R2const',paste('_R2_t',rep(1:12),sep='_'))
...
print.table(rounde(inference.est,4))
...
for (j_index in 1:3){
  ...
  u_figure_text_file_name <- paste("../results/app2", state.set[j_index], method, selection_method, no_factors, ".pdf", sep = "-")
