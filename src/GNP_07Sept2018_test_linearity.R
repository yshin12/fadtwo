...
setwd("~/Dropbox/0_Current/LLSS-Factor/Hansen-empirical-2018-09-18")
...
output_text_file_name <- paste("results/GNP", method, selection_method, no_factors, "2018-09-18.txt", sep = "_")
